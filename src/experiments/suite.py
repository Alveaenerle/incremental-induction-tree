...
class ExperimentSuite:
    ...
    def quality_comparison(self, dataset_name, data, test_size=0.3):
        ...
        f1_forest_inc = f1_score(y_test, y_pred_forest_inc, average='weighted')

        # Print results
        print(f" - MyTree (Batch):   Acc={acc_batch:.4f}, "
              f"F1={f1_batch:.4f}, Time={t_batch:.4f}s")
        print(f" - MyTree (Inc):     Acc={acc_inc:.4f}, "
              f"F1={f1_inc:.4f}, Time={t_inc:.4f}s")
        print(f" - MyForest (Inc):   Acc={acc_forest_inc:.4f}, "
              f"F1={f1_forest_inc:.4f}, Time={t_forest_inc:.4f}s")
        print(f" - Sklearn (CART):   Acc={acc_sklearn:.4f}, "
              f"F1={f1_sklearn:.4f}, Time={t_sklearn:.4f}s")
        ...
        self._plot_quality(
            ...
            f1_batch, f1_inc, f1_forest_inc, f1_sklearn
        )
    ...
    def _plot_quality(self, name, acc_batch, acc_inc, acc_forest, acc_sk,
                      ...
                      f1_batch, f1_inc, f1_forest, f1_sk):
        ...
        f1_scores = [f1_batch, f1_inc, f1_forest, f1_sk]
        f1_colors = ['mediumpurple', 'mediumseagreen', 'tomato', 'silver']
        bars3 = ax3.bar(models, f1_scores, color=f1_colors)
